import { g as getRenderingRef, f as forceUpdate, a as Build, r as registerInstance, h } from './index-d6626b81.js';
...
const HomePage = class {
  ...
  render() {
    return (h("div", null, h(Router.Switch, null, h(Route, { path: "/home" }, h("nav-bar", null), h("landing-page", null), h("hospital-footer", null)), h(Route, { path: "/" }, h("login-comp", null), h("hospital-footer", null)), h(Route, { path: "/booking" }, h("nav-bar", null), h("appointment-booking", null), h("hospital-footer", null)), h(Route, { path: "/admin" }, h("admin-navbar", null), h("admin-comp", null), h("hospital-footer", null)), h(Route, { path: "/admin/hospital" }, h("admin-navbar", null), h("admin-hospital", null), h("hospital-footer", null)), h(Route, { path: "/admin/doctors" }, h("admin-navbar", null), h("admin-doctors", null), h("hospital-footer", null)), h(Route, { path: "/admin/bookings" }, h("admin-navbar", null), h("admin-booking", null), h("hospital-footer", null)), h(Route, { path: "/admin/feedback" }, h("admin-navbar", null), h("admin-feedback", null), h("hospital-footer", null)), h(Route, { path: "/add" }, h("admin-navbar", null), h("admin-form", null), h("hospital-footer", null)), h(Route, { path: "/feedback" }, h("nav-bar", null), h("feedback-component", null), h("hospital-footer", null)), h(Route, { path: "/summary" }, h("nav-bar", null), h("summary-comp", null), h("hospital-footer", null)))));
  }
